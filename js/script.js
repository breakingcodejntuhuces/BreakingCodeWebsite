...
const teamData = [
  ...
  { name: 'P. AKHIL', role: 'Club Lead', linkedin: '#', email: 'akhil@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'M. VISHAL', role: 'Marketing Head', linkedin: '#', email: 'vishal@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'B. NIKHIL', role: 'Marketing Head', linkedin: '#', email: 'nikhil@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'M. SAI KUMAR', role: 'Tech Head', linkedin: '#', email: 'saikumar@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'G. AKSHITHA', role: 'Tech Head', linkedin: '#', email: 'akshitha@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'CH. CHANDRASHEKHAR', role: 'Tech Head', linkedin: '#', email: 'chandrashekhar@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'S. SWARUPA', role: 'Event Head', linkedin: '#', email: 'swarupa@example.com', photo: 'assets/images/team_placeholder.png' },
  ...
  { name: 'SK. SAMEENA YASMIN', role: 'Coordinator', linkedin: '#', email: 'sameena@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'C. VENKAT SHIVA SAI', role: 'Coordinator', linkedin: '#', email: 'venkat@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'B. GOVARDHAN', role: 'Coordinator', linkedin: '#', email: 'govardhan@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'M. SAI CHARAN', role: 'Coordinator', linkedin: '#', email: 'saicharan@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'A. MAHAVAISHNAVI', role: 'Coordinator', linkedin: '#', email: 'mahavaishnavi@example.com', photo: 'assets/images/team_placeholder.png' },
  { name: 'SK. MOHD. ARIF', role: 'Coordinator', linkedin: '#', email: 'mohd.arif@example.com', photo: 'assets/images/team_placeholder.png' },
